...
<header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
               ...
               <!-- searchbar-->
               <a href="index.html#search"><span class="pe-7s-search"></span></a>
               <div id="search">
             ...
             <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                     ...
                     <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu"  v-show="othe">
                           <li>
                              <ul class="menu">
                                 <li >
                                    <!-- start Orders -->
                        ...
                        <ul class="dropdown-menu"  v-show="othe">
                           <li>
                              <ul class="menu">
                                 ...
                                 <li><a href="index.html#" class="border-gray">
                     ...
                     <li class="dropdown dropdown-help hidden-xs">
                        ...
                        <ul class="dropdown-menu" v-show="othe">
                           ...
                           <li><a href="index.html#"><i class="fa fa fa-bullhorn"></i> Lan settings</a></li>
                           <li><a href="index.html#"><i class="fa fa-bar-chart"></i> Settings</a></li>
                     ...
                     <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu" v-show="profileDropdown">
                           ...
                           <li><a href="index.html#"><i class="fa fa-inbox"></i> Inbox</a></li>
                           <li><a href="login.html">
