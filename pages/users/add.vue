                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6">
                              ...
                              <div class="form-group">
                                 <label>Email</label>
                                 <input type="email" class="form-control" placeholder="Enter Email" required v-model="mail">
                              </div>
                              <div class="form-group">
                                 <label>Mobile</label>
                                 <input type="number" class="form-control" placeholder="Enter Mobile" required v-model="phone">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="reset-button">
                                 <a href="add-customer.html#" class="btn btn-warning">Reset</a>
                                 <a href="#" class="btn btn-success" v-on:click.prevent="addUser()">Save</a>
                              </div>
                           </form>
                        </div>
                     </div>
